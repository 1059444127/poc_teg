...
class GraphFrame(wx.Frame):
    ...
    def create_main_panel(self):
        ...
        self.pause_button = wx.Button(self.panel, -1, "Stop")
    ...
    def init_plot(self):
        ...
        self.axes.set_title('CoagVista GUI', size=12)
    ...
    def on_redraw_timer(self, event):
        ...
        if not self.paused:
            ...
            ### My Additions:  
            print self.datagen.next()
            strdata = str(self.datagen.next())
            target.write(strdata)
            target.write('\n')
...
if __name__ == '__main__':
	target = open('coagvista_output.txt', 'w')
	app = wx.PySimpleApp()
